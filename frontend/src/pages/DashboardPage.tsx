  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <h1 className="text-2xl font-bold text-medical-900">Dashboard</h1>
      ...
      <div className="card bg-gradient-to-r from-primary-500 to-primary-600 text-white">
        <h2 className="text-xl font-semibold mb-2">Welcome to AI Doctor Assistant</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="card">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-medical-900">0</p>
            </div>
          </div>
        </div>
        ...
        <div className="card">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-medical-600">Pending Analysis</p>
              <p className="text-2xl font-bold text-medical-900">0</p>
            </div>
          </div>
        </div>
        ...
        <div className="card">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <p className="text-sm font-medium text-medical-600">Test Reports</p>
              <p className="text-2xl font-bold text-medical-900">0</p>
            </div>
          </div>
        </div>
      ...
      {/* Recent Activity */}
      <div className="card">
        <h3 className="text-lg font-semibold text-medical-900 mb-4">Recent Activity</h3>
        <div className="text-center py-8">
          ...
          <p className="text-medical-600">No recent consultations</p>
          <p className="text-sm text-medical-500 mt-1">Start your first consultation to see activity here</p>
        </div>
      </div>
